...
(function(){
  ...
  (function(){
    ...
    const PAGE_META = {
      ...
      '/ar/cod-fulfillment/libya':   { title:'خدمة الدفع عند الاستلام في ليبيا 2026 — المنصة الأولى | MDM Express', desc:'MDM Express هي الشركة الأولى لخدمات الدفع عند الاستلام في ليبيا. توصيل لجميع المدن، معدل توصيل 50-70%، ومعدل تأكيد 75%. ابدأ البيع اليوم.' },
      '/ar/cod-fulfillment/iraq':    { title:'خدمة الدفع عند الاستلام في العراق 2026 — المنصة الأولى | MDM Express', desc:'MDM Express هي الشركة الأولى لخدمات الدفع عند الاستلام في العراق. توصيل لجميع المدن، معدل توصيل 60-80%، ومعدل تأكيد 75%. ابدأ البيع اليوم.' },
      '/ar/cod-fulfillment/lebanon': { title:'خدمة الدفع عند الاستلام في لبنان 2026 — المنصة الأولى | MDM Express', desc:'MDM Express هي الشركة الأولى لخدمات الدفع عند الاستلام في لبنان. توصيل لجميع المدن، معدل توصيل 60-80%، ومعدل تأكيد 75%. ابدأ البيع اليوم.' },
    };
